...
P,Q,m,s,e,p,a,q=20,10,5,300,{0:"· ",1:"██"},[[[[1,1],[0,1,0],[1,0,0],[0,0,1],[1]#
*3,[0]*3,[1]*4,[0]*4,[1,1,0],[0,1,1]][int(z)]for z in x]for x in'00 145 245 34\
5 845 985 7677'.split()],range,len;M,b=p[randint(0,6)],[[0]*Q for r in a(P)];#
h.cbreak();y,R,C,cr,l,d,n=lambda z,x,y:e[z[x][y]],0,4,0,1,s,p[randint(0,6)];#
w.nodelay(1);w.keypad(1);h.curs_set(0);A,B,sw=list,zip,{'U':'if not k(R,C'+#
